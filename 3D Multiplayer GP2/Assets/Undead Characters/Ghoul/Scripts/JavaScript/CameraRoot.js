...
public var targetOffset = Vector3.zero;
public var distance = 4.0;
public var lineOfSightMask : LayerMask = 0;
public var closerRadius : float = 0.2;
public var closerSnapLag : float = 0.2;
public var xSpeed = 200.0;
public var ySpeed = 80.0;
