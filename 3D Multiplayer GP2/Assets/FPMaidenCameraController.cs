...
public class FPMaidenCameraController : MonoBehaviour
{
    ...
    private void Update()
    {
        _rotation.x = Input.GetAxis("Controller X") * Sensitivity;
        _rotation.y = Input.GetAxis("Controller Y") * -Sensitivity;
